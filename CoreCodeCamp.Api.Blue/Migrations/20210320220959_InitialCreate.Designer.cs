...
namespace CoreCodeCamp.Api.Blue.Migrations
{
    ...
    [Migration("20210320220959_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreCodeCamp.Api.Blue.Data.Camp", b =>
                {
            ...
            modelBuilder.Entity("CoreCodeCamp.Api.Blue.Data.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreCodeCamp.Api.Blue.Data.Speaker", b =>
                {
            ...
            modelBuilder.Entity("CoreCodeCamp.Api.Blue.Data.Talk", b =>
                {
            ...
            modelBuilder.Entity("CoreCodeCamp.Api.Blue.Data.Camp", b =>
                {
                    b.HasOne("CoreCodeCamp.Api.Blue.Data.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreCodeCamp.Api.Blue.Data.Talk", b =>
                {
                    b.HasOne("CoreCodeCamp.Api.Blue.Data.Camp", "Camp")
                        .WithMany("Talks")
                        .HasForeignKey("CampId");

                    b.HasOne("CoreCodeCamp.Api.Blue.Data.Speaker", "Speaker")
                        .WithMany()
